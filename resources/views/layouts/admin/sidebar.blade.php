<div class="h-full text-gray-200 bg-gray-900 w-21 md:w-64 transition-all duration-300">
    {{-- Logo --}}
    <div class="flex items-center px-6 py-6 border-b border-gray-800">
        ...
        <svg class="w-6 h-6 md:hidden text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="px-4 py-6 space-y-6">
        ...
        <div>
            ...
            <a href="{{ route('admin.testimoni.index') }}"
                ...
                <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8s-9-3.582-9-8
