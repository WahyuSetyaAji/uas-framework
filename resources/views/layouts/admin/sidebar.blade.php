<div class="relative flex flex-col h-full text-gray-200 bg-gray-900">
    ...
    <div class="flex items-center justify-between px-4 py-4 border-b border-gray-800 lg:px-6">
        ...
        <button @click="openSidebar = !openSidebar"
                class="p-2 text-gray-200 transition-colors rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-700"
    ...
    <div class="flex-1 px-3 py-6 space-y-6 overflow-y-auto lg:px-4">
        ...
        <div>
            ...
            <a href="{{ route('home') }}" target="_blank"
                ...
                <svg class="flex-shrink-0 w-6 h-6 transition-colors group-hover:text-blue-400"
        ...
        <div>
            ...
            <a href="{{ route('admin.users.index') }}"
                ...
                :class="{ 'justify-center lg:justify-start': !openSidebar, 'justify-start': openSidebar }">
                <svg class="flex-shrink-0 w-6 h-6 transition-colors group-hover:text-red-300"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div>
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    :class="{ 'justify-center lg:justify-start': !openSidebar, 'justify-start': openSidebar }">
                    <svg class="flex-shrink-0 w-6 h-6 transition-colors group-hover:text-red-400"
                         fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
