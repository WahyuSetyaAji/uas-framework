            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="container mx-auto mt-5">
                        ...
                        {{-- Form edit product --}}
                        <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4 bg-gray-50 border border-gray-200 rounded-lg shadow-sm p-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_ditambahkan" name="tanggal_ditambahkan"
                                    value="{{ old('tanggal_ditambahkan', $produk->tanggal_ditambahkan) }}"
                                    class="block w-full p-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    required>
                            </div>
