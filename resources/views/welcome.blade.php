...
@section('content')
    ...
    <!-- Hero Section -->
    <section
        class="bg-gradient-to-r from-blue-900 to-red-600 text-white flex flex-col items-center justify-center text-center min-h-screen">
        <div class="px-6 mt-24">
            ...
            <a href="{{ route('produk.index') }}"
                class="bg-white text-blue-900 font-semibold px-8 py-3 rounded-lg hover:bg-gray-200 transition">
                Lihat Produk
            </a>
        </div>
    </section>
...
<a href="{{ route('login') }}">Alt Login</a>
