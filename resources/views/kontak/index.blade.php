...
@section('content')
    <section class="min-h-screen py-20 bg-gradient-to-r from-blue-100 via-white to-red-100">
        <div class="container mx-auto px-6">
            ...
            <h2 class="text-4xl font-extrabold text-blue-900 mb-12 text-center">
                Hubungi Kami
            </h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                ...
                <div>
                    <iframe
                        ...
                        width="100%" height="380" class="rounded-2xl shadow-xl border-2 border-red-400" allowfullscreen=""
                        loading="lazy">
                    </iframe>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <a href="https://wa.me/6281295588338?text=Halo%20Bowo%20Jok,%20saya%20ingin%20bertanya." target="_blank"
                        class="inline-block bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition-transform hover:scale-105">
